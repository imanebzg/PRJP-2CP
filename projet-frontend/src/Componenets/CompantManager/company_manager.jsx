...
function  CompanyManager() {
    ...
    return (
        <div className='manager'>
            ...
            {selectedCompany && (
                <div>
                    <p>Nom de l'entreprise:  <a>{selectedCompany.company_name}</a></p>
                    <p>Industrie:  <a> {selectedCompany.industry}</a></p>
                    <p>Email:   <a> {selectedCompany.email}</a></p>
                    <p>Numero de telephone:   <a> {selectedCompany.phone_number}</a></p>
                    <p>Personne à contacter:  <a>  {selectedCompany.contact_person}</a></p>
                    <p>Adresse:  <a>{selectedCompany.location}</a></p>
                    <p>Code postal:  <a>{selectedCompany.postal_code}</a></p>
