  ...
  return (
    <div>
      <form action="http://localhost:3309/calc/bilan" method="POST">
        ...
        <select id="Secteur2" name="secteur2" value={secteur2} onChange={handleChange(setSecteur2)}>
          <option value="">--select--</option>
        ...
        <select id="Secteur3" name="secteur3" value={secteur3} onChange={handleChange(setSecteur3)}>
          <option value="">--select--</option>
        ...
        <select id="Secteur4" name="secteur4" value={secteur4} onChange={handleChange(setSecteur4)}>
          <option value="">--select--</option>
      ...
      <option key={index} value={option}>{option === '' ? '\u00A0' : option}</option>
        ...
        <select id="nom" name="nom" value={produit} onChange={handleChange(setproduit)}>
          <option value="">--select--</option>
        ...
        <select id="ligne" name="ligne" value={ligne} onChange={handleChange(setligne)}>
          <option value="">--select--</option>
        ...
        <select id="poste" name="poste" value={poste} onChange={handleChange(setposte)}>
          <option value="">--select--</option>
        ...
        <select id="unite" name="unite" value={unite} onChange={handleChange(setunite)}>
          <option value="">--select--</option>
